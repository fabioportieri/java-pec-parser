...
public class MimeTypesUtil {
	...
	public static String guessMimeType(String extension) {
		...
		for (Map.Entry<String, List<String>> entry : mimeTypesMap.entrySet()) {
			List<String> values = entry.getValue();
			for (String value : values) {
				if (value.equals(extension.toLowerCase())) {
					mimeType.add(entry.getKey());
					break;
				}
			}
		}
	...
	private static String excludeMimeTypes(List<String> pattern, List<String> mimeTypes) {
		...
		for (String p : pattern) {
			List<String> nMime2 = new ArrayList<String>(nMime);
			nMime.clear();
	...
	public static String guessExtension(String fullMimeType) {
		...
		for (Map.Entry<String, List<String>> entry : mimeTypesMap.entrySet()) {
			...
			if (fullMimeType.toLowerCase().contains(key.toLowerCase())) {
				result = values.get(0);
				break;
			}
		}
